...
weights_name = "geoseg_ftunetformer_goldmdd_b8_e80_poly_ce_dice"
...
net = ft_unetformer(num_classes=num_classes, decoder_channels=256, pretrained=False, weight_path=None)
loss = JointLoss(
