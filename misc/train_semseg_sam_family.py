...
def parse_args() -> argparse.Namespace:
    ...
    # SAM 2.1
    p.add_argument("--sam2-root", type=Path, default=Path((os.environ['ELDOR_THIRD_PARTY'] + '/sam2')))
    ...
    # SAM 3
    p.add_argument("--sam3-root", type=Path, default=Path((os.environ['ELDOR_THIRD_PARTY'] + '/sam3')))
    ...
    # HQ-SAM
    p.add_argument("--hqsam-root", type=Path, default=Path((os.environ['ELDOR_THIRD_PARTY'] + '/sam-hq')))
...
def main() -> None:
    ...
    args_dump = portable_metadata(vars(args))
