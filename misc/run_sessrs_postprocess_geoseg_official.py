...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--repo-root", type=Path, default=Path((os.environ['ELDOR_THIRD_PARTY'] + '/GeoSeg')))
    ...
    p.add_argument("--sam-prior-root", type=Path, default=Path((os.environ['ELDOR_ROOT'] + '/data-cropped-samrs-priors')))
