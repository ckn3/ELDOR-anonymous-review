...
EXP_ROOT = Path((os.environ['ELDOR_EXPERIMENT_ROOT']))
...
def main() -> None:
    ...
    block.append(f'- Heatmap: `experiments/diagnostics/val_per_class_iou_completed_models_heatmap.png`')
    ...
    block.append(f'- Heatmap: `experiments/diagnostics/test_per_class_iou_completed_models_heatmap.png`')
