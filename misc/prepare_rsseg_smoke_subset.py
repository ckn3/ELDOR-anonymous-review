...
def main() -> None:
    ...
    ap.add_argument("--src-root", type=Path, default=Path((os.environ['ELDOR_PATCH_ROOT'])))
    ap.add_argument("--dst-root", type=Path, default=Path((os.environ['ELDOR_ROOT'] + '/data-cropped-rsseg-smoke')))
