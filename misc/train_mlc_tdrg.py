...
sys.path.insert(0, str(MLC_ROOT / 'repos/TDRG'))
...
class TDRGTrainer(BaseMLCTrainer):
    def build_model(self):
        ...
        res101 = tv.resnet101(weights=tv.ResNet101_Weights.IMAGENET1K_V1)
        model  = get_model(NUM_CLASSES, args)
        logger.info("TDRG built ✅")
        return model
